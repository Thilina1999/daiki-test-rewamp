  ...
  return (
    <div className="flex flex-col md:col-span-3">
      <TitleContent
        ...
        customStyles={
          "text-4xl font-extrabold text-title-black text-center pb-5 md:pr-10 md:pl-10 px-0"
        }
      />
      <TitleContent
        text={
        ...
        customStyles={
          "text-base font-normal text-justify leading-8 text-gray-160 md:pr-10 md:pl-10"
        }
      />
    </div>
  );
